$document.ready(function () {
    ...
    fighter[0].picture = "../images/luke-skywalker.JPG";
    ...
    fighter[1].picture = "../images/rey.JPG";
    ...
    fighter[2].picture = "../images/kylo-ren.JPG";
    ...
    fighter[3].picture = "../images/darth-vader.JPG";
});
